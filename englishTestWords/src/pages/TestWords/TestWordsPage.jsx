...
const TestWordsPage = () => {
    ...
    const checkWord = () => {
        ...
        const wordIndex = words.findIndex(findWord => findWord.word == currentShuffledWord.word);

        newWords[wordIndex].tries += 1;
        if (currentShuffledWord.translates.includes(word)) {
